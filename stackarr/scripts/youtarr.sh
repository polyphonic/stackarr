...
print_status() {
    ...
    echo "YouTube library: ${YOUTARR_OUTPUT_ROOT:-$MEDIA_ROOT/Videos/YouTube} -> /usr/src/app/data"
...
set_enabled() {
    ...
    set_env_value YOUTARR_OUTPUT_ROOT "${YOUTARR_OUTPUT_ROOT:-$MEDIA_ROOT/Videos/YouTube}"
