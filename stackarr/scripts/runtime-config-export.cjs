...
const allowed = new Set([
  ...
  'QUESTARR_ROMM_DOWNLOAD_ROOT',
  'QUESTARR_ROMM_LIBRARY_ROOT',
  'QUESTARR_ROMM_CLAMAV_ENABLED',
  'QUESTARR_ROMM_CLAMAV_HOST',
  ...
  'CLEANUPARR_DATABASE_PROVIDER',
  'CLEANUPARR_POSTGRES_HOST',
  'CLEANUPARR_POSTGRES_PORT',
