...
- Credentials cannot be changed through MCP calls.
...
Treat that profile like administrator access to the Docker host. Keep the MCP transport local and review Agent Activity regularly.
