...
| tinyMediaManager | scan Arr-managed movie or TV destinations; approve scan + scrape workflows for new items; never rename media |
...
- “Scrape new Arr imports in tinyMediaManager without renaming media.”
