...
<figure className="docsScreenshot">
  <span className="themeShot">
    <img className="themeShotLight" src="/screenshots/stackarr-dashboard-light.png" alt="Stackarr dashboard showing active work, running containers, and live CPU and memory history" />
    <img className="themeShotDark" src="/screenshots/stackarr-dashboard-dark.png" alt="" aria-hidden="true" />
  </span>
  <figcaption>The current dashboard keeps live system context and the next useful action on one calm operating surface.</figcaption>
</figure>
