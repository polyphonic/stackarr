...
function buildSetupEnv(input: ResolvedMediaServerSetupInput) {
  ...
  const env: StackarrEnv = {
    ...
    CLEANUPARR_DATABASE_PROVIDER: postgresMode ? 'postgres' : 'sqlite',
    ...
    CLEANUPARR_POSTGRES_PASSWORD: databasePassword,
    ...
    BOOKORBIT_URL: 'http://127.0.0.1:42873',
    BOOKORBIT_APP_URL: 'http://127.0.0.1:42873',
    BOOKORBIT_CLIENT_URL: 'http://127.0.0.1:42873',
